 ...
 */
public class MaterialQuickContactBadge extends AppCompatImageView implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (mContactUri != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                QuickContact.showQuickContact(getContext(), MaterialQuickContactBadge.this, mContactUri,
    ...
    public CharSequence getAccessibilityClassName() {
        return MaterialQuickContactBadge.class.getName();
    }
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            if (trigger && mContactUri != null) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    QuickContact.showQuickContact(getContext(), MaterialQuickContactBadge.this, lookupUri,
                            QuickContact.MODE_LARGE, mExcludeMimes);
                }
